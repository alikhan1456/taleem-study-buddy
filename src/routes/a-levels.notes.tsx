...
export const Route = createFileRoute("/a-levels/notes")({
  head: () => ({
    meta: [
      { title: "A-Levels Notes | Taleem" },
      {
        name: "description",
        content: "A-Level revision notes organised by subject.",
      },
      { property: "og:title", content: "A-Levels Notes — Taleem" },
      {
        property: "og:description",
        content: "Revision notes for A-Level students.",
      },
        ...
        <section className="flex-1">
          ...
          <div className="mt-6 rounded-2xl border border-border bg-card p-6 shadow-[var(--shadow-soft)] sm:p-8">
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
              This page will list subject-by-subject A-Level notes. Resources will be added here soon.
            </p>
          </div>
        </section>
